 ...
 * <ul>
 *   <li>{@code LLM_BASE_URL}，例如 {@code https://opencode.ai/zen/go/v1}</li>
 *   <li>{@code LLM_API_KEY}</li>
 *   <li>{@code LLM_MODEL}</li>
 * </ul>
 *
 * <p>本章模型按 system prompt 的约定返回结构化 JSON，落在
 * {@code choices[0].message.content} 里，由 {@link ToolCallParser} 解析。
 */
